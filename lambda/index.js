...
const STREAM='https://halo.streamerr.co/listen/radio_freccia_nera__italian_notes/radio.mp3';
...
const Help={canHandle:h=>Alexa.getRequestType(h.requestEnvelope)==='IntentRequest'&&['AMAZON.HelpIntent','AMAZON.FallbackIntent'].includes(Alexa.getIntentName(h.requestEnvelope)),handle:h=>h.responseBuilder.speak(isIT(h)?"Di: Alexa, apri Note d'Italia.":'Say: Alexa, open Freccia Nera Italian Notes.').getResponse()};
